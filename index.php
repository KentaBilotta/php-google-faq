<?php
    $faqs = [
        // faq 1
        [
            "question" => "<h2>Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?
            </h2>",
        ...
        [
            ...
            <p>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</p>
